    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (!empty($admin_role)) {
            ...
            $role = Role::create([
                ...
                'role_description' => 'Gestion des données faisant fonctionner la plateforme'
            ]);
        ...
        return redirect('/dashboard')->with('success_message', 'Bienvenue ' . $user->firstname . ' ' . $user->lastname . ' !');
    }
}
